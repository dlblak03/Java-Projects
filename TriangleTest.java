...
public class TriangleTest {
	...
	public static void main(String[] args) {
		...
		System.out.print("Enter the x coordinate for vertex 1: ");
		v1x = scan.nextInt();
		System.out.print("Enter the y coordinate for vertex 1: ");
		v1y = scan.nextInt();
		System.out.print("Enter the x coordinate for vertex 2: ");
		v2x = scan.nextInt();
		System.out.print("Enter the y coordinate for vertex 2: ");
		v2y = scan.nextInt();
		System.out.print("Enter the x coordinate for vertex 3: ");
		v3x = scan.nextInt();
		System.out.print("Enter the y coordinate for vertex 3: ");
		v3y = scan.nextInt();
